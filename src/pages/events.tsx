...
const Events = () => {
  ...
  const ongoingSectionTitle = useExtractSectionTitle(
    "ongoing_events_section_title"
  );
  const futureSectionTitle = useExtractSectionTitle(
    "future_events_section_title"
  );
